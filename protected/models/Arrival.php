...
/**
 * This is the model class for table "tbl_arrival".
 *
 * The followings are the available columns in table 'tbl_arrival':
 * @property integer $id
...
class Arrival extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('arrival_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_equipment, arrival_date, amount, id_person, notes', 'safe', 'on'=>'search'),
		);
	}
